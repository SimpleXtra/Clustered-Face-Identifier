# Cluster Image Identifier App
This app, just like its name suggests, recognizes the number of unique faces in a video with YOLOv11 and Facenet512. It utilizes Gradio for deployment.
